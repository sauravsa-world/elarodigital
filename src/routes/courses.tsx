...
export const Route = createFileRoute("/courses")({
  head: () => ({
    meta: [
      ...
      { name: "twitter:title", content: "Digital Marketing Courses in Bihar — Elaro Digital" },
      { name: "twitter:description", content: "Cohort-based, project-driven digital marketing courses for Bihar." },
    ],

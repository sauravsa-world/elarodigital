...
export const Route = createFileRoute("/portfolio")({
  head: () => ({
    meta: [
      ...
      { name: "twitter:title", content: "Portfolio — Elaro Digital | Bihar Marketing Case Studies" },
      { name: "twitter:description", content: "Selected projects and campaigns from businesses across Bihar." },
    ],
